...
scaledDf = selector.fit_transform(scaledDf, labels)

print('anuroopa', selector.get_support())
...
clf = svm.LinearSVC(penalty='l2', loss='squared_hinge' ,random_state=None, max_iter=100,C=1)
